...
export const WIDGET_MANIFEST: WidgetManifestEntry[] = [
    ...
    { type: 'current-working-folder', create: () => new widgets.CurrentWorkingFolderWidget() },
    ...
    { type: 'tokens-tools', create: () => new widgets.TokensToolsWidget() },
    { type: 'tokens-tool-calls', create: () => new widgets.TokensToolCallsWidget() },
    { type: 'tokens-tool-outputs', create: () => new widgets.TokensToolOutputsWidget() },
    { type: 'tokens-assistant', create: () => new widgets.TokensAssistantWidget() },
    { type: 'tokens-user', create: () => new widgets.TokensUserWidget() },
